      ...
      <div id="all-product" className="container-fluid p-0 py-5">
        <div className="row m-auto">
          <div className="col-2 p-0 overflow-auto">
            ...
            <div className="gachsp candivleft">
              <a className="dropdown-toggle m-0 py-3" data-bs-toggle="collapse" href="#collapseGender" aria-expanded="false" aria-controls="collapseGender">
                Gender
              </a>
            ...
            <div className="gachsp candivleft">
              <a className="dropdown-toggle m-0 py-3" data-bs-toggle="collapse" href="#collapsePrice" aria-expanded="false" aria-controls="collapsePrice">
                Product By Price
              </a>
            ...
            <div className="gachsp candivleft">
              <a className="dropdown-toggle m-0 py-3" data-bs-toggle="collapse" href="#collapseColor" aria-expanded="false" aria-controls="collapseColor">
                Product By Color
              </a>
            ...
            <div className="gachsp candivleft">
              <a className="dropdown-toggle m-0 py-3" data-bs-toggle="collapse" href="#collapseBrand" aria-expanded="false" aria-controls="collapseBrand">
                Product By Brand
              </a>
            ...
            <div className="gachsp candivleft">
              <a className="dropdown-toggle m-0 py-3" data-bs-toggle="collapse" href="#collapseSport" aria-expanded="false" aria-controls="collapseSport">
                Sport
              </a>
